...
//Y Axis. Try 1
G91 G31 Y-#2 F#3 P#30 L#31 Q1  ;move back
IF #1921==0GOTO1  ;edge not found!
#22=#1926  ;store back position
G53 Y[#22+#15]   ;отскок
G91 G31 Y[-#15*2] F#14 P#30 L#31 Q1  ;move back
IF #1921==0GOTO1  ;edge not found!
#22=#1926
G53 Y#11  ;returns to the starting point

G91 G31 Y#2 F#3 P#30 L#31 Q1  ;move front
IF #1921==0GOTO1  ;edge not found!
...
//X Axis
G91 G31 X-#1 F#3 P#30 L#31 Q1  ;move left
IF #1920==0 GOTO1  ;edge not found!
#20=#1925  ;store left position
G53 X[#20+#15]   ;отскок
G91 G31 X[-#15*2] F#14 P#30 L#31 Q1  ;move left
IF #1920==0 GOTO1  ;edge not found!
#20=#1925
G53 X#10  ;returns to the starting point

G91 G31 X#1 F#3 P#30 L#31 Q1  ;move right
IF #1920==0 GOTO1  ;edge not found!
#21=#1925  ;store right position
G53 X[#21-#15]   ;отскок
G91 G31 X[#15*2] F#14 P#30 L#31 Q1  ;move right
IF #1920==0 GOTO1  ;edge not found!
#21=#1925
