...
- **IN03**: YunKia V6 (TP06) 3D Touch Probe - NPN Normally Open, 24V, <0.01mm repeatability
...
| IN03 | 3D probe | YunKia V6 NPN NO | Direct | ✅ Working |
...
- **YunKia V6 (TP06) 3D touch probe** (Workpiece edge finding, center finding, surface mapping, IN03) - ✅ **NPN Normally Open - Working**
...
### **YunKia V6 (TP06) 3D Touch Probe - Direct Wired - ✅ NPN WORKING**
- **Model**: YunKia V6 Anti-roll 3D Touch Probe (TP06)
- **Type**: 3-Axis Active Probe (Stylus with tungsten steel ball tip)
- **Output Type**: **NPN Normally Open (NO)** ✅ Compatible with DDCS
- **Input**: **IN03** (Input #03)
- **Function**: Edge finding, Center finding, Surface mapping, Complex geometry probing
- **Repeatability**: <0.01mm @ 50-200mm/min feed rate
- **Operating Voltage**: DC 5V-24V (using 24V)
- **Shank Diameter**: 6mm (standard router collet compatible)

**Wiring Configuration:**
- **RED (VCC)**: +24V from Wago Hub or DDCS 24V+ terminal
- **BLACK (GND)**: COM- (Ground) from DDCS
- **YELLOW (Signal)**: IN03 terminal on DDCS
- **Shield Mesh**: Chassis ground (prevents electrical noise)

**Installation**: Added with Expert upgrade, replacing previous PNP probe

**Status**: ✅ **WORKING - NPN output matches DDCS input requirements**

**LED Indicators (On probe body):**
- **Steady Green**: Powered on, ready to probe (not triggered)
- **Steady Red**: Contact detected (triggered state)

**Physical Safety Limits:**
⚠️ **Do not exceed:**
- **XY Over-travel**: ±4mm maximum swing
- **Z-axis Over-travel**: 2mm maximum compression
- Exceeding these limits will damage the probe

**Controller Configuration:**
- **Parameter #043 (IN03)**: Set to **0** (Active Low)
  - Probe is "Normally Open" when not touching
  - When triggered, signal pulls to ground
  - DDCS detects ground = probe triggered
- **Verification**: IN03 shows OFF when not touching, ON when stylus pushed

**Best Practices for Accuracy:**
1. **Cleanliness**: Clean workpiece and tungsten ball before probing
2. **Feed Rate**: 50-100 mm/min for final precision probe (<0.01mm repeatability)
3. **Fast Approach**: 150-200 mm/min for initial contact search
4. **Two-Stage Probing**: Fast approach + slow precision touch (recommended)
5. **Shielding**: Cable shield grounded to machine chassis (prevents false triggers)
6. **Material**: Works with conductive materials (aluminum, steel, brass, copper)
7. **Cable Routing**: Keep probe cable away from motor/VFD power cables

**Complete Technical Documentation:**
See `yunkia-v6-probe.md` for:
- Complete specifications and wiring diagrams
- G31 probe command integration
- Example G-code macros (auto-zero, edge finder, center finder)
- Troubleshooting guide
- Maintenance and care procedures
- Integration checklist

**Advantages:**
- ✅ NPN output - Direct connection to DDCS (no converter needed)
- ✅ High precision - <0.01mm repeatability
- ✅ Visual feedback - LED status indicators
- ✅ Wide voltage range - 5V-24V compatible
- ✅ Durable - Tungsten steel ball tip, stainless steel stylus
- ✅ Standard mounting - 6mm shank fits router collets
...
| YunKia V6 TP06 3D Touch Probe | IN03 | Edge/center finding, digitizing | Complex geometry | ✅ Working |

**YunKia V6 (TP06) 3D Touch Probe:**
...
| YunKia V6 3D probe | IN03 | NPN Normally Open | ✅ Working |

**3D probe now working:** YunKia V6 TP06 probe with NPN output is compatible with DDCS inputs. See `yunkia-v6-probe.md` for complete documentation.
